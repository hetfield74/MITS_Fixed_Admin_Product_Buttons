...
MITS Fixed Admin Product Buttons für modified eCommerce Shopsoftware
...
Anleitung für das Modul MITS Fixed Admin Product Buttons
========================================================================================================
...
Die Installation und Nutzung des Moduls MITS Fixed Admin Product Buttons erfolgt auf eigene Gefahr!

Die Installation des Modul MITS Fixed Admin Product Buttons ist in der aktuellen Shopversion ab 2.x ziemlich einfach.
    ...
    2. Kopieren Sie anschließend einfach alle Dateien in dem Verzeichnis shoproot aus dem Modulpaket 
       MITS Fixed Admin Product Buttons in das Hauptverzeichnis ihrer bestehenden 
...
--------------------------------------------------------------------------------------------------------
Wir hoffen, das Modul MITS Fixed Admin Product Buttons für die modified eCommerce Shopsoftware 2.x gefällt ihnen! 
